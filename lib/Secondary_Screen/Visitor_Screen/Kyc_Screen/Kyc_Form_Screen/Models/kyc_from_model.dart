...
class KycFromModel {
  ...
  File? identification_front;
  File? identification_back;
  File? pp_size_photo;
  ...
  KycFromModel.fromJson(Map<String, dynamic> json) {
    user = json['user'];
    name = json['name'];
   ...
   identification_front=json["identity_documents_front"];
   identification_back=json["identity_documents_back"];
   pp_size_photo=json["pp_size_photo"];
   dob = json["dob_date"];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['permanent_address_city_village_area'] = this.permanentAddressCityVillageArea;
    ...
    data['current_address_city_village_area'] = this.currentAddressCityVillageArea;
    ...
    data['identity_documents_front']=this.identification_front;
    data['identity_documents_back']= this.identification_back;
    data['pp_size_photo'] = this.pp_size_photo;
    data['dob_date'] = this.dob;
    return data;
  }
}
